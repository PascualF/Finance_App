    ...
    return (
        <header className="flex justify-between items-center bg-gradient-to-r from-slate-800 to-gray-700 text-white py-2 px-6 shadow-md">
            <div className="flex items-center">
                <button className="md:hidden mr-2 h-11 items-center" onClick={toggleSidebar}>
                    <MenuIcon />
                </button>
                <div>
            ...
            <div className="flex items-center gap-3">
                ...
                <span className="text-white font-medium"><span className="hidden md:block lg:block">Pascual Felicio</span> (username)</span>
            </div>
        </header>
    );
}